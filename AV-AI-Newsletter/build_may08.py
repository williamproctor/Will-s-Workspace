#!/usr/bin/env python3
"""Build the May 8, 2026 edition HTML page from the markdown sources."""
import json
import os

ROOT = os.path.dirname(os.path.abspath(__file__))
MD_PATH = os.path.join(ROOT, "editions", "2026-05-08.md")
SIMPLIFIED_PATH = os.path.join(ROOT, "editions", "2026-05-08-simplified.md")
OUT_DIR = os.path.join(ROOT, "site", "editions", "2026-05-08")
...
OG_DESCRIPTION = (
    "Cannes 2026 opens Tuesday with the AI question split clean down the middle: "
    "AGC boards \"Critterz\" while the festival bans AI from Palme d'Or competition. "
    "OpenAI ships GPT-5.5 Instant as the new ChatGPT default. xAI's Grok 4.3 lands "
    "with strong agentic benchmarks at half the price. Topaz adds Hyperion 2 + a "
    "native Premiere panel. Twinnin raises $3M to license actor likenesses while "
    "YouTube's deepfake-detection rolls out to Hollywood."
)
...
<head>
  ...
  <title>The AVS AI Dispatch &mdash; Week of May 8, 2026 | The AVS AI Dispatch</title>
  <meta name="description" content="{META_DESCRIPTION}">
  <meta property="og:title" content="The AVS AI Dispatch — Week of May 8, 2026">
  <meta property="og:description" content="{OG_DESCRIPTION}">
  <meta property="og:type" content="article">
  <meta property="og:url" content="https://avaidispatch.com/editions/2026-05-08">
  ...
  <link rel="canonical" href="https://avaidispatch.com/editions/2026-05-08">
...
<body>
      ...
      <div class="latest-edition" id="editionContainer">
        <div class="edition-header">
          <div class="edition-meta">
            <span class="edition-badge">2026-05-08</span>
            <span class="edition-date">2026-05-08</span>
          </div>
  ...
  <script>
    ...
    const AUDIO_SRC = "/audio/2026-05-08.m4a";
    const AUDIO_TITLE = "AVS AI Dispatch \u2014 Audio Summary";

    const VIDEO_SRC = "/video/2026-05-08.mp4";
    const VIDEO_TITLE = "Cannes 2026's Split Position: AI Welcomed to the Market, Banned From Competition";
    const VIDEO_THUMB = "/video/thumbs/2026-05-08.png";
