#!/usr/bin/env python3
"""Build the June 19, 2026 edition HTML page from the markdown sources."""
import json
import os

ROOT = os.path.dirname(os.path.abspath(__file__))
MD_PATH = os.path.join(ROOT, "editions", "2026-06-19.md")
SIMPLIFIED_PATH = os.path.join(ROOT, "editions", "2026-06-19-simplified.md")
OUT_DIR = os.path.join(ROOT, "site", "editions", "2026-06-19")
...
OG_DESCRIPTION = (
    "Adobe Firefly AI Assistant moves into Premiere, Photoshop, Illustrator, "
    "InDesign, and Frame.io. Google Vids adds longer Veo clips and parallel "
    "generation. Palmier Pro brings MCP-connected agents to a Mac video "
    "timeline. Claude Fable 5 reaction remains focused on hard coding and "
    "long-horizon agent work. LTX Trainer makes open audio-video models more "
    "customizable, while Mistral Voxtral TTS adds a compact multilingual "
    "voice model."
)
...
<head>
  ...
  <title>The AVS AI Dispatch &mdash; Week of June 19, 2026 | The AVS AI Dispatch</title>
  <meta name="description" content="{META_DESCRIPTION}">
  <meta property="og:title" content="The AVS AI Dispatch — Week of June 19, 2026">
  <meta property="og:description" content="{OG_DESCRIPTION}">
  <meta property="og:type" content="article">
  <meta property="og:url" content="https://avaidispatch.com/editions/2026-06-19">
  ...
  <link rel="canonical" href="https://avaidispatch.com/editions/2026-06-19">
  ...
  <link rel="stylesheet" href="/shared.css?v=20260622">
</head>
<body>
      ...
      <div class="latest-edition" id="editionContainer">
        <div class="edition-header">
          <div class="edition-meta">
            <span class="edition-badge">2026-06-19</span>
            <span class="edition-date">2026-06-19</span>
          </div>
  ...
  <script src="/shared.js?v=20260622"></script>
  <script>
    const EDITION_MD = {edition_md_js};
    const HAS_AUDIO = true;
    const AUDIO_SRC = "/audio/2026-06-19.m4a";
    const AUDIO_TITLE = "AVS AI Dispatch \\u2014 Audio Summary";

    const VIDEO_SRC = "/video/2026-06-19.mp4";
    const VIDEO_TITLE = "The Assistant Enters the Edit";
    const VIDEO_THUMB = "/video/thumbs/2026-06-19.png";
