#!/usr/bin/env python3
"""Build the June 12, 2026 edition HTML page from the markdown sources."""
import json
import os

ROOT = os.path.dirname(os.path.abspath(__file__))
MD_PATH = os.path.join(ROOT, "editions", "2026-06-12.md")
SIMPLIFIED_PATH = os.path.join(ROOT, "editions", "2026-06-12-simplified.md")
OUT_DIR = os.path.join(ROOT, "site", "editions", "2026-06-12")
...
OG_DESCRIPTION = (
    "Luma Ray 3.2 brings AI video closer to production finishing with "
    "frame-level control, HDR, EXR export, and API access. PixVerse Canvas "
    "turns AI video into a node-based workspace with Seedance 2.0 support. "
    "Claude Fable 5 draws strong reaction for hard coding and long-horizon "
    "agent work. ElevenLabs Avatars combines voice and lip-sync video in one "
    "flow, while Apple Music Understanding and Google Magenta RealTime 2 move "
    "audio intelligence closer to local creative tools."
)
...
<head>
  ...
  <title>The AVS AI Dispatch &mdash; Week of June 12, 2026 | The AVS AI Dispatch</title>
  <meta name="description" content="{META_DESCRIPTION}">
  <meta property="og:title" content="The AVS AI Dispatch — Week of June 12, 2026">
  <meta property="og:description" content="{OG_DESCRIPTION}">
  <meta property="og:type" content="article">
  <meta property="og:url" content="https://avaidispatch.com/editions/2026-06-12">
  ...
  <link rel="canonical" href="https://avaidispatch.com/editions/2026-06-12">
...
<body>
      ...
      <div class="latest-edition" id="editionContainer">
        <div class="edition-header">
          <div class="edition-meta">
            <span class="edition-badge">2026-06-12</span>
            <span class="edition-date">2026-06-12</span>
          </div>
  ...
  <script>
    ...
    const AUDIO_SRC = "/audio/2026-06-12.m4a";
    const AUDIO_TITLE = "AVS AI Dispatch \\u2014 Audio Summary";

    const VIDEO_SRC = "/video/2026-06-12.mp4";
    const VIDEO_TITLE = "Finish Every Cut";
    const VIDEO_THUMB = "/video/thumbs/2026-06-12.png";
