#!/usr/bin/env python3
"""Build the July 24, 2026 edition HTML page from the markdown sources."""
import json
import os

ROOT = os.path.dirname(os.path.abspath(__file__))
MD_PATH = os.path.join(ROOT, "editions", "2026-07-24.md")
SIMPLIFIED_PATH = os.path.join(ROOT, "editions", "2026-07-24-simplified.md")
OUT_DIR = os.path.join(ROOT, "site", "editions", "2026-07-24")
...
OG_DESCRIPTION = (
    "FLUX 3 proposes one backbone across image, video, audio, and action, but "
    "only Video and Action entered gated early access. Qwen-Audio adds directed "
    "multilingual voice, Runway Media Router turns model choice into policy, "
    "Sonilo uses picture to time effects, and Qwen-Image and ElevenMusic expand "
    "reference-driven control. More modalities require more control while "
    "independent evidence continues to lag launch velocity."
)
...
<head>
  ...
  <title>The AVS AI Dispatch &mdash; Week of July 24, 2026 | The AVS AI Dispatch</title>
  <meta name="description" content="{META_DESCRIPTION}">
  <meta property="og:title" content="The AVS AI Dispatch — Week of July 24, 2026">
  <meta property="og:description" content="{OG_DESCRIPTION}">
  <meta property="og:type" content="article">
  <meta property="og:url" content="https://avaidispatch.com/editions/2026-07-24">
  ...
  <link rel="canonical" href="https://avaidispatch.com/editions/2026-07-24">
...
<body>
      ...
      <div class="latest-edition" id="editionContainer">
        <div class="edition-header">
          <div class="edition-meta">
            <span class="edition-badge">2026-07-24</span>
            <span class="edition-date">2026-07-24</span>
          </div>
  ...
  <script>
    ...
    const AUDIO_SRC = "/audio/2026-07-24.m4a";
    const AUDIO_TITLE = "AVS AI Dispatch \\u2014 Audio Summary";

    const VIDEO_SRC = "/video/2026-07-24.mp4";
    const VIDEO_TITLE = "More Modalities, More Control";
    const VIDEO_THUMB = "/video/thumbs/2026-07-24.png";
