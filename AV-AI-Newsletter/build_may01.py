#!/usr/bin/env python3
"""Build the May 1, 2026 edition HTML page from the markdown sources."""
import json
import os

ROOT = os.path.dirname(os.path.abspath(__file__))
MD_PATH = os.path.join(ROOT, "editions", "2026-05-01.md")
SIMPLIFIED_PATH = os.path.join(ROOT, "editions", "2026-05-01-simplified.md")
OUT_DIR = os.path.join(ROOT, "site", "editions", "2026-05-01")
...
OG_DESCRIPTION = (
    "Insta360 + Splatica's Project Eternal turns a 360 camera walk-through into a "
    "navigable Gaussian splat. Whittemore's Agent OS framework argues the model "
    "matters less than the personal infrastructure underneath it. Alibaba's "
    "HappyHorse 1.0 takes the #1 video model crown. ElevenLabs ships ElevenMusic "
    "with a style-royalty deal. Topaz rebuilds its stack. Anthropic ships "
...
<head>
  ...
  <title>The AVS AI Dispatch &mdash; Week of May 1, 2026 | The AVS AI Dispatch</title>
  <meta name="description" content="{META_DESCRIPTION}">
  <meta property="og:title" content="The AVS AI Dispatch — Week of May 1, 2026">
  <meta property="og:description" content="{OG_DESCRIPTION}">
  <meta property="og:type" content="article">
  <meta property="og:url" content="https://avaidispatch.com/editions/2026-05-01">
  ...
  <link rel="canonical" href="https://avaidispatch.com/editions/2026-05-01">
...
<body>
      ...
      <div class="latest-edition" id="editionContainer">
        <div class="edition-header">
          <div class="edition-meta">
            <span class="edition-badge">2026-05-01</span>
            <span class="edition-date">2026-05-01</span>
          </div>
  ...
  <script>
    ...
    const AUDIO_SRC = "/audio/2026-05-01.m4a";
    const AUDIO_TITLE = "AVS AI Dispatch \u2014 Audio Summary";

    const VIDEO_SRC = "/video/2026-05-01.mp4";
    const VIDEO_TITLE = "The Agent OS Shift: Why the Model You Pick Matters Less Than the Foundation Underneath";
    const VIDEO_THUMB = "/video/thumbs/2026-05-01.png";
