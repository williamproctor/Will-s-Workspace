#!/usr/bin/env python3
"""Build the May 15, 2026 edition HTML page from the markdown sources."""
import json
import os

ROOT = os.path.dirname(os.path.abspath(__file__))
MD_PATH = os.path.join(ROOT, "editions", "2026-05-15.md")
SIMPLIFIED_PATH = os.path.join(ROOT, "editions", "2026-05-15-simplified.md")
OUT_DIR = os.path.join(ROOT, "site", "editions", "2026-05-15")
...
OG_DESCRIPTION = (
    "OpenAI ships three Realtime voice models — streaming transcription at "
    "$1.02/hour, live translation at $2.04/hour, and a GPT-5-class voice "
    "agent. Anthropic locks down 220K GPUs via SpaceX and doubles Claude "
    "Code rate limits. Cannes 2026 launches Human Provenance disclosure "
    "standard and Soderbergh premieres an AI-assisted Lennon documentary. "
    "Krea 2 ships a style-first image model. Flick raises $6M. Vertigo + "
...
<head>
  ...
  <title>The AVS AI Dispatch &mdash; Week of May 15, 2026 | The AVS AI Dispatch</title>
  <meta name="description" content="{META_DESCRIPTION}">
  <meta property="og:title" content="The AVS AI Dispatch — Week of May 15, 2026">
  <meta property="og:description" content="{OG_DESCRIPTION}">
  <meta property="og:type" content="article">
  <meta property="og:url" content="https://avaidispatch.com/editions/2026-05-15">
  ...
  <link rel="canonical" href="https://avaidispatch.com/editions/2026-05-15">
...
<body>
      ...
      <div class="latest-edition" id="editionContainer">
        <div class="edition-header">
          <div class="edition-meta">
            <span class="edition-badge">2026-05-15</span>
            <span class="edition-date">2026-05-15</span>
          </div>
  ...
  <script>
    ...
    const AUDIO_SRC = "/audio/2026-05-15.m4a";
    const AUDIO_TITLE = "AVS AI Dispatch \u2014 Audio Summary";

    const VIDEO_SRC = "/video/2026-05-15.mp4";
    const VIDEO_TITLE = "Voice \u2014 The New Unit Economics: Why This Week's OpenAI Pricing Drop Rewrites What AV Teams Can Build";
    const VIDEO_THUMB = "/video/thumbs/2026-05-15.png";
