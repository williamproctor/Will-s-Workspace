#!/usr/bin/env python3
"""Build the July 3, 2026 edition HTML page from the markdown sources."""
import json
import os

ROOT = os.path.dirname(os.path.abspath(__file__))
MD_PATH = os.path.join(ROOT, "editions", "2026-07-03.md")
SIMPLIFIED_PATH = os.path.join(ROOT, "editions", "2026-07-03-simplified.md")
OUT_DIR = os.path.join(ROOT, "site", "editions", "2026-07-03")
...
OG_DESCRIPTION = (
    "Google brought Veo 3.1 into Flow with audio support across reference, "
    "frame, and extension workflows. Anthropic released Claude Sonnet 5 for "
    "lower-cost agentic coding and tool use. Runway expanded its Bertelsmann "
    "partnership, Adobe's Topaz deal put enhancement and restoration back in "
    "focus, and the video model market kept splitting around native audio, "
    "reference capacity, editable outputs, and workflow deployment."
)
...
<head>
  ...
  <title>The AVS AI Dispatch &mdash; Week of July 3, 2026 | The AVS AI Dispatch</title>
  <meta name="description" content="{META_DESCRIPTION}">
  <meta property="og:title" content="The AVS AI Dispatch — Week of July 3, 2026">
  <meta property="og:description" content="{OG_DESCRIPTION}">
  <meta property="og:type" content="article">
  <meta property="og:url" content="https://avaidispatch.com/editions/2026-07-03">
  ...
  <link rel="canonical" href="https://avaidispatch.com/editions/2026-07-03">
...
<body>
      ...
      <div class="latest-edition" id="editionContainer">
        <div class="edition-header">
          <div class="edition-meta">
            <span class="edition-badge">2026-07-03</span>
            <span class="edition-date">2026-07-03</span>
          </div>
  ...
  <script>
    ...
    const AUDIO_SRC = "/audio/2026-07-03.m4a";
    const AUDIO_TITLE = "AVS AI Dispatch \\u2014 Audio Summary";

    const VIDEO_SRC = "/video/2026-07-03.mp4";
    const VIDEO_TITLE = "Video Becomes Editable";
    const VIDEO_THUMB = "/video/thumbs/2026-07-03.png";
