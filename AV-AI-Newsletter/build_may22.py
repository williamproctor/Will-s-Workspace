#!/usr/bin/env python3
"""Build the May 22, 2026 edition HTML page from the markdown sources."""
import json
import os

ROOT = os.path.dirname(os.path.abspath(__file__))
MD_PATH = os.path.join(ROOT, "editions", "2026-05-22.md")
SIMPLIFIED_PATH = os.path.join(ROOT, "editions", "2026-05-22-simplified.md")
OUT_DIR = os.path.join(ROOT, "site", "editions", "2026-05-22")
...
OG_DESCRIPTION = (
    "Google I/O 2026: Gemini Omni Flash ships a multimodal video model with "
    "conversational editing to the Gemini app, Flow, and free to YouTube "
    "Shorts. Gemini 3.5 Flash claims 4x speed and <50% cost vs Claude Opus "
    "4.7 and GPT-5.5. Flow becomes a creative copilot with Flow Agent and "
    "vibe-coded Flow Tools. Lyria 3 + Pro ship for developers. Karpathy "
    "joins Anthropic to accelerate pre-training research. OpenAI disproves "
    "an 80-year-old Erdos conjecture. Cannes 2026 wraps: AI came out of "
    "the closet."
)
...
<head>
  ...
  <title>The AVS AI Dispatch &mdash; Week of May 22, 2026 | The AVS AI Dispatch</title>
  <meta name="description" content="{META_DESCRIPTION}">
  <meta property="og:title" content="The AVS AI Dispatch — Week of May 22, 2026">
  <meta property="og:description" content="{OG_DESCRIPTION}">
  <meta property="og:type" content="article">
  <meta property="og:url" content="https://avaidispatch.com/editions/2026-05-22">
  ...
  <link rel="canonical" href="https://avaidispatch.com/editions/2026-05-22">
...
<body>
      ...
      <div class="latest-edition" id="editionContainer">
        <div class="edition-header">
          <div class="edition-meta">
            <span class="edition-badge">2026-05-22</span>
            <span class="edition-date">2026-05-22</span>
          </div>
  ...
  <script>
    ...
    const AUDIO_SRC = "/audio/2026-05-22.m4a";
    const AUDIO_TITLE = "AVS AI Dispatch \u2014 Audio Summary";

    const VIDEO_SRC = "/video/2026-05-22.mp4";
    const VIDEO_TITLE = "The Multimodal Collapse \u2014 Inside Google I/O 2026";
    const VIDEO_THUMB = "/video/thumbs/2026-05-22.png";
