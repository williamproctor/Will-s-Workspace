#!/usr/bin/env python3
"""Build the May 29, 2026 edition HTML page from the markdown sources."""
import json
import os

ROOT = os.path.dirname(os.path.abspath(__file__))
MD_PATH = os.path.join(ROOT, "editions", "2026-05-29.md")
SIMPLIFIED_PATH = os.path.join(ROOT, "editions", "2026-05-29-simplified.md")
OUT_DIR = os.path.join(ROOT, "site", "editions", "2026-05-29")
...
OG_DESCRIPTION = (
    "Runway ships Aleph 2.0 + Edit Studio — in-context video editing, 30s at "
    "1080p, multi-shot consistency. Amazon MGM + AWS announce the GenAI "
    "Creators' Fund at AI on the Lot in Culver City and unveil Project Nara, "
    "calling it the only end-to-end AI content creation ecosystem in the "
    "industry. Stable Audio 3 ships open-weight, runs on a MacBook Pro M4. "
    "Threadline launches as the first AI editor cutting on intonation, not "
    "silence. Avaturn open-sources AVTR-1 with sub-200ms real-time avatar "
    "duplex. Microsoft Build (June 2-3) and Apple WWDC (June 8-12) up next."
)
...
<head>
  ...
  <title>The AVS AI Dispatch &mdash; Week of May 29, 2026 | The AVS AI Dispatch</title>
  <meta name="description" content="{META_DESCRIPTION}">
  <meta property="og:title" content="The AVS AI Dispatch — Week of May 29, 2026">
  <meta property="og:description" content="{OG_DESCRIPTION}">
  <meta property="og:type" content="article">
  <meta property="og:url" content="https://avaidispatch.com/editions/2026-05-29">
  ...
  <link rel="canonical" href="https://avaidispatch.com/editions/2026-05-29">
...
<body>
      ...
      <div class="latest-edition" id="editionContainer">
        <div class="edition-header">
          <div class="edition-meta">
            <span class="edition-badge">2026-05-29</span>
            <span class="edition-date">2026-05-29</span>
          </div>
  ...
  <script>
    ...
    const AUDIO_SRC = "/audio/2026-05-29.m4a";
    const AUDIO_TITLE = "AVS AI Dispatch \u2014 Audio Summary";

    const VIDEO_SRC = "/video/2026-05-29.mp4";
    const VIDEO_TITLE = "The Editing Model Comes of Age";
    const VIDEO_THUMB = "/video/thumbs/2026-05-29.png";
