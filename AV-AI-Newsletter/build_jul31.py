#!/usr/bin/env python3
"""Build the July 31, 2026 edition HTML page from the markdown sources."""
import json
import os

ROOT = os.path.dirname(os.path.abspath(__file__))
MD_PATH = os.path.join(ROOT, "editions", "2026-07-31.md")
SIMPLIFIED_PATH = os.path.join(ROOT, "editions", "2026-07-31-simplified.md")
OUT_DIR = os.path.join(ROOT, "site", "editions", "2026-07-31")
...
OG_DESCRIPTION = (
    "MiniMax H3 and Seedance 2.5 launched on July 31 with different evidence: "
    "H3 had a live priced API and independent preference snapshots, while "
    "Seedance offered 30-second audio-video generation and up to 50 references "
    "with its API and independent evaluation still pending. OpenAI split file "
    "and live transcription, xAI expanded video references, Luma added editable "
    "image layers, Google updated music generation, and audio provenance moved "
    "into automated intake."
)
...
<head>
  ...
  <title>The AVS AI Dispatch &mdash; Week of July 31, 2026 | The AVS AI Dispatch</title>
  <meta name="description" content="{META_DESCRIPTION}">
  <meta property="og:title" content="The AVS AI Dispatch — Week of July 31, 2026">
  <meta property="og:description" content="{OG_DESCRIPTION}">
  <meta property="og:type" content="article">
  <meta property="og:url" content="https://avaidispatch.com/editions/2026-07-31">
  ...
  <link rel="canonical" href="https://avaidispatch.com/editions/2026-07-31">
...
<body>
      ...
      <div class="latest-edition" id="editionContainer">
        <div class="edition-header">
          <div class="edition-meta">
            <span class="edition-badge">2026-07-31</span>
            <span class="edition-date">2026-07-31</span>
          </div>
  ...
  <script>
    ...
    const AUDIO_SRC = "/audio/2026-07-31.m4a";
    const AUDIO_TITLE = "AVS AI Dispatch \\u2014 Audio Summary";

    const VIDEO_SRC = "/video/2026-07-31.mp4";
    const VIDEO_TITLE = "Two Models, Two Evidence Levels";
    const VIDEO_THUMB = "/video/thumbs/2026-07-31.png";
