#!/usr/bin/env python3
"""Build the July 10, 2026 edition HTML page from the markdown sources."""
import json
import os

ROOT = os.path.dirname(os.path.abspath(__file__))
MD_PATH = os.path.join(ROOT, "editions", "2026-07-10.md")
SIMPLIFIED_PATH = os.path.join(ROOT, "editions", "2026-07-10-simplified.md")
OUT_DIR = os.path.join(ROOT, "site", "editions", "2026-07-10")
...
OG_DESCRIPTION = (
    ...
    "to redesign complete workflows. Runway Dev unifies first- and third-party "
    "media models behind one enterprise platform. Meta launched Muse Image and "
    "previewed Muse Video, GPT-5.6 became generally available with ChatGPT Work, "
    "and LucidLink connected Frame.io footage with external production storage."
)
...
<head>
  ...
  <title>The AVS AI Dispatch &mdash; Week of July 10, 2026 | The AVS AI Dispatch</title>
  <meta name="description" content="{META_DESCRIPTION}">
  <meta property="og:title" content="The AVS AI Dispatch — Week of July 10, 2026">
  <meta property="og:description" content="{OG_DESCRIPTION}">
  <meta property="og:type" content="article">
  <meta property="og:url" content="https://avaidispatch.com/editions/2026-07-10">
  ...
  <link rel="canonical" href="https://avaidispatch.com/editions/2026-07-10">
...
<body>
      ...
      <div class="latest-edition" id="editionContainer">
        <div class="edition-header">
          <div class="edition-meta">
            <span class="edition-badge">2026-07-10</span>
            <span class="edition-date">2026-07-10</span>
          </div>
  ...
  <script>
    ...
    const AUDIO_SRC = "/audio/2026-07-10.m4a";
    const AUDIO_TITLE = "AVS AI Dispatch \\u2014 Audio Summary";

    const VIDEO_SRC = "/video/2026-07-10.mp4";
    const VIDEO_TITLE = "The Workflow Is the Unit";
    const VIDEO_THUMB = "/video/thumbs/2026-07-10.png";
