#!/usr/bin/env python3
"""Build the April 24, 2026 edition HTML page from the markdown sources."""
import json
import os

ROOT = os.path.dirname(os.path.abspath(__file__))
MD_PATH = os.path.join(ROOT, "editions", "2026-04-24.md")
SIMPLIFIED_PATH = os.path.join(ROOT, "editions", "2026-04-24-simplified.md")
OUT_DIR = os.path.join(ROOT, "site", "editions", "2026-04-24")
...
OG_DESCRIPTION = (
    "OpenAI ships GPT-5.5 and ChatGPT Images 2.0 in 48 hours — Images 2.0 opens "
    "the biggest Arena leaderboard lead in history. Kling adds native 4K output. "
    "DaVinci Resolve 21 lands with 10+ AI tools. NAB 2026 confirms every major NLE "
    "is now AI-native. DeepSeek V4 matches GPT-5.5 at 86% lower cost."
)
...
<head>
  ...
  <title>The AVS AI Dispatch &mdash; Week of April 24, 2026 | The AVS AI Dispatch</title>
  <meta name="description" content="{META_DESCRIPTION}">
  <meta property="og:title" content="The AVS AI Dispatch — Week of April 24, 2026">
  <meta property="og:description" content="{OG_DESCRIPTION}">
  <meta property="og:type" content="article">
  <meta property="og:url" content="https://avaidispatch.com/editions/2026-04-24">
  ...
  <link rel="canonical" href="https://avaidispatch.com/editions/2026-04-24">
...
<body>
      ...
      <div class="latest-edition" id="editionContainer">
        <div class="edition-header">
          <div class="edition-meta">
            <span class="edition-badge">2026-04-24</span>
            <span class="edition-date">2026-04-24</span>
          </div>
  ...
  <script>
    ...
    const AUDIO_SRC = "/audio/2026-04-24.m4a";
    const AUDIO_TITLE = "AVS AI Dispatch \u2014 Audio Summary";

    const VIDEO_SRC = "/video/2026-04-24.mp4";
    const VIDEO_TITLE = "Step-Change Week: When Every Creative Tool Leveled Up at Once";
    const VIDEO_THUMB = "/video/thumbs/2026-04-24.png";
